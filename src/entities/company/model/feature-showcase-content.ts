...
export const featureShowcaseContentByLocale: Record<Locale, FeatureShowcaseContent> = {
  ko: {
    eyebrow: "Infra",
    title: "제도권 안에서 움직이는\n디지털 자산 인프라",
  ...
  en: {
    ...
    description: "The trading, payments, and remittance service rails run on strict compliance under VASP regulation.",
  },
}

// TODO(real-data): 와이어프레임 플레이스홀더 카피. 실제 상품/모듈 설명 확정 후 교체 필요.
export const featureShowcaseItemsByLocale: Record<Locale, FeatureShowcaseItem[]> = {
  ko: [
    {
      id: "trading",
      iconShape: "square",
  ...
  en: [
    ...
    },
    {
      ...
      title: "Payments",
      description:
        "Handles collection and settlement while hiding chain and wallet complexity. Chargeback-free by design.",
    },
    {
      id: "settlement",
      iconShape: "diamond",
      title: "Settlement",
      description:
        "Handles cross-border remittance, including Travel Rule exchange, in a single call.",
    },
  ],
}
...
export const featureShowcaseHighlightsByLocale: Record<Locale, FeatureShowcaseHighlight[]> = {
  ko: [
    {
      id: "license",
  ...
  en: [
    ...
    {
      id: "travel-rule",
      title: "Travel Rule Verification & AML/KYT Detection",
      description:
        "Real-time on-chain monitoring (KYT) and anomaly detection (FDS) are built into the gateway layer, handling Travel Rule exchange and AML events in real time.",
    },
    {
      id: "b2b",
      title: "Alongside Our Partners",
      description:
        "We put our partners' business growth first, and focus every capability we have toward that goal.",
    },
    {
      id: "on-off-ramp",
      title: "On/Off-Ramp",
      description:
        "On/off-ramp, collection, payout, top-up, remittance, and settlement: in step with the coming demand in digital asset payments and remittance, we're preparing the entire flow as a single infrastructure under applicable regulation.",
    },
  ],
}
